...
public class Icons {
	...
	public static final Image			META_FILE_ICON_IMAGE = META_FILE_ICON.createImage();
	
	public static final ImageDescriptor INFO_ICON = img("icons/obj16/info.png");
	public static final Image 			INFO_ICON_IMAGE = INFO_ICON.createImage();
	...
	public static final Image 			META_PROJECT_ERROR_ICON_IMAGE = META_PROJECT_ERROR_ICON.createImage();
	public static final ImageDescriptor META_PROJECT_CLOSED_ICON = img("icons/obj16/closed_project.png");
	public static final Image 			META_PROJECT_CLOSED_ICON_IMAGE = META_PROJECT_CLOSED_ICON.createImage();
	public static final ImageDescriptor META_PROJECT_LOADED_ICON = img("icons/obj16/open_project.png");
	public static final Image 			META_PROJECT_LOADED_ICON_IMAGE = META_PROJECT_LOADED_ICON.createImage();
	public static final ImageDescriptor META_JAVA_PROJECT_LOADED_ICON = img("icons/obj16/open_project_java.png");
	public static final Image 			META_JAVA_PROJECT_LOADED_ICON_IMAGE = META_JAVA_PROJECT_LOADED_ICON.createImage();
	public static final ImageDescriptor META_CPP_PROJECT_LOADED_ICON = img("icons/obj16/open_project_cpp.png");
	public static final Image 			META_CPP_PROJECT_LOADED_ICON_IMAGE = META_CPP_PROJECT_LOADED_ICON.createImage();
	public static final ImageDescriptor TASK_GROUP_ICON = img("icons/obj16/task_group.png");
	public static final Image 			TASK_GROUP_ICON_IMAGE = TASK_GROUP_ICON.createImage();
	public static final ImageDescriptor TASK_ICON = img("icons/obj16/task.png");
	public static final Image 			TASK_ICON_IMAGE = TASK_ICON.createImage();
